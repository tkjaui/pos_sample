        ...
        <div class="box box-success">
          ...
          <form role="form" method="post" class="saleForm">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td style="width:50%">
                            <div class="input-group">
                              <input type="number" class="form-control input-lg" name="newTaxSale" id="newTaxSale" placeholder="0" min="0" required>
                          ...
                          <td style="width:50%">
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control input-lg" name="newSaleTotal" id="newSaleTotal" placeholder="00000" totalSale="" readonly required>
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-primary pull-left">Save sale</button>
            </div>
          </form>
